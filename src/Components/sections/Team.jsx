        ...
        <div className="md:pt-[100px] pt-[90px] sm:pt-[80px] pb-[50px] sm:pb-[30px]">
            <div className="wraper">
                ...
                <div className="grid grid-cols-12 gap-x-4">
                    <div className="col-span-3 lg:col-span-3 md:col-span-6 col:col-span-12">
                        <div className="text-center relative transition-all z-10 group mb-7">
                            <div className="wpo-team-img">
                                <img src="assets/images/team/img-2.jpg" alt="" className="group-hover:scale-[1.2] rounded-full" />
                                <div
                                 ...
                                 rounded-[50%] transition-all translate-y-full pt-4 group-hover:translate-y-0 group-hover:top-[10%]">
                                    <div>
                                        <h2 className="font-heading-font font-normal text-3xl text-white lg:text-2xl">Alexa
                                            Mirta</h2>
                                        <span className="font-base-font font-normal text-base text-white">Vegetables
                                            Farmer</span>
                    ...
                    <div className="col-span-3 lg:col-span-3 md:col-span-6 col:col-span-12">
                        <div className="text-center relative transition-all z-10 group mb-7">
                            <div className="wpo-team-img"> 
                                <img src="assets/images/team/img-1.jpg" alt="" className="group-hover:scale-[1.2] rounded-full" />
                                <div
                                    className="absolute left-0 -top-[10%] w-full h-full flex justify-center flex-col
                                 rounded-[50%] transition-all translate-y-full pt-4 group-hover:translate-y-0 group-hover:top-[10%]">
                                    <div>
                                        <h2 className="font-heading-font font-normal text-3xl text-white lg:text-2xl">Harry
                                            Abraham</h2>
                                        <span className="font-base-font font-normal text-base text-white">Agriculture
                                            Farmer</span>
                                        <ul className="flex justify-center mt-4">
                                            <li><a href="#"
                                                className="inline-block w-10 h-10 leading-10 border border-white text-white rounded-full relative overflow-hidden after:absolute after:left-0 after:top-0 after:w-full after:h-full after:transition-all after:-translate-x-full after:bg-[rgba(255,255,255,0.5)] hover:after:translate-x-full"><i
                    ...
                    <div className="col-span-3 lg:col-span-3 md:col-span-6 col:col-span-12">
                        <div className="text-center relative transition-all z-10 group mb-7">
                            <div className="wpo-team-img">
                                <img src="assets/images/team/img-3.jpg" alt="" className="group-hover:scale-[1.2] rounded-full" />
                                <div
                                    className="absolute left-0 -top-[10%] w-full h-full flex justify-center flex-col
                                 rounded-[50%] transition-all translate-y-full pt-4 group-hover:translate-y-0 group-hover:top-[10%]">
                                    <div>
                                        <h2 className="font-heading-font font-normal text-3xl text-white lg:text-2xl">
                                            Jewelia Orchid</h2>
                                        <span className="font-base-font font-normal text-base text-white">Vegetables
                                            Farmer</span>
                                        <ul className="flex justify-center mt-4">
                    ...
                    <div className="col-span-3 lg:col-span-3 md:col-span-6 col:col-span-12">
                        <div className="text-center relative transition-all z-10 group mb-7">
                            <div className="wpo-team-img">
                                <img src="assets/images/team/img-4.jpg" alt="" className="group-hover:scale-[1.2] rounded-full" />
                                <div
                                    className="absolute left-0 -top-[10%] w-full h-full flex justify-center flex-col
                                 rounded-[50%] transition-all translate-y-full pt-4 group-hover:translate-y-0 group-hover:top-[10%]">
                                    <div>
                                        <h2 className="font-heading-font font-normal text-3xl text-white lg:text-2xl">Robert
                                            Johnson</h2>
                                        <span className="font-base-font font-normal text-base text-white">Agriculture
                                            Farmer</span>
                                        <ul className="flex justify-center mt-4">
